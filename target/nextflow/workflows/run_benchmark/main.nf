// run_benchmark build_throwaway_build_registry_check
// 
...
meta = [
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--method_ids",
          "description" : "A list of method (base) ids to run, e.g. `ae_l32`, `nlscvi_l512`,\n`pca_l128`, `ground_truth`. If not specified, all methods run across\nthe full latent x seed grid.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
  ...
  "dependencies" : [
    ...
    {
      "name" : "methods/pca_reconstruction",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "methods/autoencoder",
      "repository" : {
        "type" : "local"
      }
    },
    ...
    {
      "name" : "metrics/statistical",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "metrics/biological",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "metrics/knn_purity",
      "repository" : {
        "type" : "local"
      }
    }
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_expression_reconstruction/task_expression_reconstruction/src/workflows/run_benchmark/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { pca_reconstruction } from "${meta.resources_dir}/../../../nextflow/methods/pca_reconstruction/main.nf"
include { autoencoder } from "${meta.resources_dir}/../../../nextflow/methods/autoencoder/main.nf"
include { scvi } from "${meta.resources_dir}/../../../nextflow/methods/scvi/main.nf"
include { statistical } from "${meta.resources_dir}/../../../nextflow/metrics/statistical/main.nf"
include { biological } from "${meta.resources_dir}/../../../nextflow/metrics/biological/main.nf"
include { knn_purity } from "${meta.resources_dir}/../../../nextflow/metrics/knn_purity/main.nf"
