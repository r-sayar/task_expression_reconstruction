// statistical build_throwaway_build_registry_check
// 
...
meta = [
    ...
    "metrics" : [
      {
        "name" : "r2",
        "label" : "Gene-sum R²",
        "summary" : "R² between gene-wise summed expression across cells.",
        "description" : "Coefficient of determination computed on the per-gene sum of expression\nacross all cells in the solution and prediction matrices.\n",
        "min" : "-inf",
        "max" : 1,
        "maximize" : true,
        "references" : {
      ...
      },
      {
        ...
        "summary" : "Cell-wise mean squared error between matched cells.",
        "description" : "Mean squared error between solution and prediction expression matrices.\nRequires the same number of cells in both inputs (matched ``obs_names``).\n",
        "min" : 0,
        "max" : "inf",
        "maximize" : false,
        "references" : {
      ...
      },
      {
        ...
        "summary" : "Multivariate energy distance between cell distributions.",
        "description" : "Energy distance between the empirical distributions of cells in\nsolution and prediction expression space.\n",
        "min" : 0,
        "max" : "inf",
        "maximize" : false,
        "references" : {
          "bibtex" : "@article{szekely:13,\n  author = {Sz\\\\'ekely, G\\\\'abor J. and Rizzo, Maria L.},\n  title = {Energy statistics: A class of statistics based on distances},\n  journal = {Journal of Statistical Planning and Inference},\n  volume = {143},\n  number = {8},\n  pages = {1249--1272},\n  year = {2013}\n}\n"
        },
        "links" : {
          "documentation" : "https://reconeval.readthedocs.io"
        }
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_expression_reconstruction/task_expression_reconstruction/src/metrics/statistical/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/metrics/statistical",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "r-sayar/task_expression_reconstruction/metrics/statistical",
