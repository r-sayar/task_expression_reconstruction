...
meta = [
  ...
  "name" : "biological",
  "namespace" : "metrics",
  "version" : "build_fix_ci_test_fixtures",
  "argument_groups" : [
    {
      "name" : "Arguments",
      "arguments" : [
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.4",
    "git_commit" : "ef5a043bc0f36622c085fad65d3ab68b8a8125f3",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_expression_reconstruction/metrics/biological",
    "tag" : "build_fix_ci_test_fixtures"
  },
  "label" : [
    "midtime",
    "highmem",
