// knn_purity build_throwaway_build_registry_check
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "label" : "Solution",
          "summary" : "Ground-truth expression for held-out test cells.",
          "description" : "Ground-truth perturbed cells (positive pool). Optional; when absent the\nmetric emits NA (observational datasets have no perturbation pools).\n",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "uns" : [
        ...
        },
        {
          ...
          "label" : "Solution",
          "summary" : "Ground-truth expression for held-out test cells.",
          "description" : "Ground-truth control cells (negative pool). Optional; when absent the\nmetric emits NA.\n",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "uns" : [
        ...
        },
        {
          ...
          "description" : "Where to read predicted expression: ``X`` for ``.X``, a layer name, or\nan ``.obsm`` key when ``--use_rep`` is set.\n",
          "default" : [
            "X"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--solution_layer",
          "description" : "Where to read solution expression: ``X`` for ``.X``, a layer name, or\nan ``.obsm`` key when ``--use_rep`` is set.\n",
          "default" : [
            "X"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--use_rep",
          "description" : "If set, use ``.obsm[use_rep]`` instead of expression layers for all\ninputs. Recommended for latent-space perturbation scoring.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_expression_reconstruction/task_expression_reconstruction/src/metrics/knn_purity/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/metrics/knn_purity",
    "viash_version" : "0.9.4",
...
par = {
  ...
  'input_solution_perturbed': $( if [ ! -z ${VIASH_PAR_INPUT_SOLUTION_PERTURBED+x} ]; then echo "r'${VIASH_PAR_INPUT_SOLUTION_PERTURBED//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_solution_control': $( if [ ! -z ${VIASH_PAR_INPUT_SOLUTION_CONTROL+x} ]; then echo "r'${VIASH_PAR_INPUT_SOLUTION_CONTROL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "r-sayar/task_expression_reconstruction/metrics/knn_purity",
