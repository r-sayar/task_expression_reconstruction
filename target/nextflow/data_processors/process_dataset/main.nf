// process_dataset build_throwaway_build_registry_check
// 
...
meta = [
      ...
      "arguments" : [
        {
          ...
          "summary" : "Raw or preprocessed LuCA expression data.",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "obs" : [
                ...
                },
                {
                  "type" : "string",
                  "name" : "dataset",
                  "description" : "Study / dataset identifier within LuCA",
                  "required" : false
                },
                {
                  "type" : "string",
                  "name" : "origin",
                  "description" : "Tissue origin (e.g. tumor_primary, normal_adjacent)",
                  "required" : false
                }
              ],
              "uns" : [
          ...
          "example" : [
            "resources_test/common/luca/dataset.h5ad"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
        ...
        },
        {
          "type" : "double",
          "name" : "--test_fraction",
          "description" : "Fraction of cells assigned to the test set (random split).",
          "default" : [
            0.2
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--obs_origin",
          "description" : ".obs column used for origin-based splits.",
          "default" : [
            "origin"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--test_origin",
          "description" : "Origin label held out for testing when method=origin.",
          "default" : [
            "tumor_primary"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--seed",
          "description" : "Random seed for splitting and HVG selection.",
          "default" : [
            0
          ],
          "required" : false,
  ...
  "test_resources" : [
    {
      "type" : "file",
      "path" : "/resources_test/common/luca",
      "dest" : "resources_test/common/luca"
    },
    {
      "type" : "python_script",
  ...
  "info" : {
    ...
    "type_info" : {
      ...
      "summary" : "Process a common dataset into train/test/solution splits.",
      "description" : "Normalizes expression, selects highly variable genes, and splits cells\ninto train and held-out test sets for gene-expression reconstruction.\n"
    }
  },
  "status" : "enabled",
  "scope" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_expression_reconstruction/task_expression_reconstruction/src/data_processors/process_dataset/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'test_fraction': $( if [ ! -z ${VIASH_PAR_TEST_FRACTION+x} ]; then echo "float(r'${VIASH_PAR_TEST_FRACTION//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'obs_origin': $( if [ ! -z ${VIASH_PAR_OBS_ORIGIN+x} ]; then echo "r'${VIASH_PAR_OBS_ORIGIN//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'test_origin': $( if [ ! -z ${VIASH_PAR_TEST_ORIGIN+x} ]; then echo "r'${VIASH_PAR_TEST_ORIGIN//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "r-sayar/task_expression_reconstruction/data_processors/process_dataset",
