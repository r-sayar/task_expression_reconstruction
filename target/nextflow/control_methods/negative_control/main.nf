// negative_control build_throwaway_build_registry_check
// 
...
meta = [
  ...
  "info" : {
    ...
    "label" : "Negative control (training mean)",
    "summary" : "Predicts the gene-wise training mean for every test cell.",
    "description" : "Broadcasts the mean expression vector computed from training cells as the\nprediction for every test cell, completely ignoring test-cell identity.\nAny method that genuinely captures cell-state information should score\nstrictly above this baseline on all metrics.\n",
    "type" : "control_method",
    "type_info" : {
      "label" : "Control method",
      "summary" : "A control method for sanity-checking the benchmark pipeline.",
      "description" : "A control method that copies ground-truth expression into the\nprediction slot to validate metric components.\n"
    }
  },
  "status" : "enabled",
  "scope" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_expression_reconstruction/task_expression_reconstruction/src/control_methods/negative_control/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "r-sayar/task_expression_reconstruction/control_methods/negative_control",
