// ground_truth build_throwaway_build_registry_check
// 
...
meta = [
  ...
  "info" : {
    ...
    "label" : "Ground truth",
    "summary" : "Copies solution expression (metric sanity check).",
    "type" : "control_method",
    "type_info" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_expression_reconstruction/task_expression_reconstruction/src/control_methods/ground_truth/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "r-sayar/task_expression_reconstruction/control_methods/ground_truth",
