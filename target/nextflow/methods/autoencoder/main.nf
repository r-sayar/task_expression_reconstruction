// autoencoder build_throwaway_build_registry_check
// 
...
meta = [
      ...
      "arguments" : [
        {
          ...
          "name" : "--input_train",
          "label" : "Training data",
          "summary" : "Training cells for reconstruction methods.",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "uns" : [
          ...
          "example" : [
            "resources_test/reconeval/luca/train.h5ad"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
        ...
        },
        {
          ...
          "name" : "--input_test",
          "label" : "Test data",
          "summary" : "Held-out test cells whose expression will be reconstructed.",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "uns" : [
          ...
          "example" : [
            "resources_test/reconeval/luca/test.h5ad"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_hidden",
          "description" : "Width of each hidden layer. Used when `--hidden_widths` is not given.\n",
          "default" : [
            256
          ],
          "required" : false,
        ...
        },
        {
          "type" : "integer",
          "name" : "--n_layers",
          "description" : "Number of hidden layers on the encoder (mirrored in decoder). Used when\n`--hidden_widths` is not given.\n",
          "default" : [
            2
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Library-size handling. `none`=AE, `observed`=olAE, `modeled`=mlAE.\n",
          "default" : [
            "none"
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_expression_reconstruction/task_expression_reconstruction/src/methods/autoencoder/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/autoencoder",
    "viash_version" : "0.9.4",
...
par = {
  ...
  'hidden_widths': $( if [ ! -z ${VIASH_PAR_HIDDEN_WIDTHS+x} ]; then echo "r'${VIASH_PAR_HIDDEN_WIDTHS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'library_size_mode': $( if [ ! -z ${VIASH_PAR_LIBRARY_SIZE_MODE+x} ]; then echo "r'${VIASH_PAR_LIBRARY_SIZE_MODE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "r-sayar/task_expression_reconstruction/methods/autoencoder",
