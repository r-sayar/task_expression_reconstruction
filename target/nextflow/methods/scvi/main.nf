// scvi build_throwaway_build_registry_check
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--variant",
          "description" : "scVI variant. `scvi`=standard, `mlscvi`=modeled library,\n`nlscvi`=Normal-likelihood VAE.\n",
          "default" : [
            "scvi"
          ],
          "required" : false,
        ...
        },
        {
          ...
          "description" : "Optional explicit gene likelihood override. When unset, the value is\nderived from `--variant`.\n",
          "required" : false,
          "choices" : [
            "zinb",
            "nb",
        ...
        },
        {
          "type" : "double",
          "name" : "--max_kl_weight",
          "description" : "Target KL warmup weight (the paper's `max_kl_weight`), passed to the\nscvi-tools training plan.\n",
          "default" : [
            1.0
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_expression_reconstruction/task_expression_reconstruction/src/methods/scvi/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'variant': $( if [ ! -z ${VIASH_PAR_VARIANT+x} ]; then echo "r'${VIASH_PAR_VARIANT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'max_kl_weight': $( if [ ! -z ${VIASH_PAR_MAX_KL_WEIGHT+x} ]; then echo "float(r'${VIASH_PAR_MAX_KL_WEIGHT//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "r-sayar/task_expression_reconstruction/methods/scvi",
